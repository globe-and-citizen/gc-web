...
push_frontend_image:
	aws lightsail push-container-image --region ca-central-1 --service-name container-service-2 --label gcwebfrontendv4 --image frontend_image_new:latest

push_backend_image:
	aws lightsail push-container-image --region ca-central-1 --service-name container-service-3 --label gcwebbackendv3 --image backend_image:latest