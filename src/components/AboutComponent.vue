    ...
    <div class="hero-content flex-col lg:flex-row lg:gap-10 border-x-2 border-black py-12">
      <div class="flex-1 prose lg:prose-xl">
        ...
        <p>
          ...
          climate change, to name only a few, cannot be solved by any one nation acting alone.
          Therefore, we have set out to create a global forum that is free from singular regional
